...
RSpec.describe Post, type: :model do
  ...
  describe "voting" do
    ...
    describe "upvotes" do
      it "counts the number of the votes with a value of 1" do
    ...
    describe "update_rank" do
      ...
      it "calculates the correct rank" do
        post.update_rank
        expect(post.rank).to eq(post.points + (post.created_at - Time.new(1970,1,1)) / 1.day.second)
      end
    ...
    describe "After create" do
      ...
      it "associates vote with owner post" do
